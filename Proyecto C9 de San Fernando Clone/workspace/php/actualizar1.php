			...
			if(
				...
				$_POST["status_sistema"]!="")
				{
					...
					if($query!=null)	{
						...
						print "<script>alert(\"Actualizado exitosamente.\");window.location='../ver3.php';</script>";
			}else{
						print "<script>alert(\"No se pudo actualizar.\");window.location='../ver3.php';</script>";
